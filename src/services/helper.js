export const numerator = (arr, counter) => {
...
export const parseFormattedMileage = (num) => num.toLocaleString("en-EN");

export const parseFormattedPrice = (str) => str.split("").slice(1).join("");
